 ...
 *
 * It also removes a tell. Several of the other sources print "Thee" and "Him" for God
 * while KJV and WEBBE never do, so without this a capital pronoun would mean "not the
 * Bible". Now both sides capitalise the same way.
 *
 * This game also raises me, my, mine and myself when God, Jesus or the Holy Spirit is the
 * speaker (the BSB does the same for Bible lines), because a few sources print "Me" and
 * "My" for Christ. Who Said It? does not: there a capital Me would name the speaker.
 *
 ...
 *
 * Zero dependencies. The same code as demos/who-said-it/scripts/capitals.mjs except for
 * the first-person words in PRONOUNS.
 */
