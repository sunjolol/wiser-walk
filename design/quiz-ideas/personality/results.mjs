...
export const TYPES = {
  ...
  spark: { ink: '#EE7F5E', art: 'spark', name: 'The Spark', disposition: 'cheerful', makeup: 'restless', opposite: 'deepwell',
    ...
    kindred: [
      { who: 'Augustine, as a young man', img: 'augustine-of-hippo', text: 'Before his conversion he loved talk, jokes, reading together and friendly arguments. In his Confessions he calls it “a restless youthfulness”. He is honest there, too, about where his love of pleasure had led him.', src: 'Augustine, Confessions' },
    ] },
  ...
  stillwater: { ink: '#4FA3BC', art: 'stillwater', name: 'The Still Water', disposition: 'careful', makeup: 'quiet', opposite: 'herald',
    ...
    kindred: [
      ...
      { who: 'Jeremiah', img: 'jeremiah', text: 'When God called him, he pleaded that he was too young to speak. Gregory says he held back out of love: he longed to stay close to God in quiet.', src: 'Jeremiah 1:6; Pastoral Rule I.7' },
